...
buildPythonApplication rec {
  pname = "kitty";
  version = "unstable-2021-03-03g${builtins.substring 0 9 src.rev}";
  format = "other";

  src = fetchFromGitHub {
    owner = "kovidgoyal";
    repo = "kitty";
    rev = "1ded78a98c87f953df2c49089265eaba50865da9";
    sha256 = "1php903rd6axx99h52qyhv58pa8sgyg3qvm3c5x55pi5rg0zqh1x";
  };
