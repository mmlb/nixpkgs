...
in
  stdenv.mkDerivation rec {
    ...
    version = "unstable-2019-08-18g${builtins.substring 0 9 src.rev}";

    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "2963533fe1124139a5a8992ddf8d5b197b21cd51";
      sha256 = "095wvxzjxmnc91q269vmwi60a8pinnch1x8bk8d25f55l48h2rni";
    };
