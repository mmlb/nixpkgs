...
in
  stdenv.mkDerivation rec {
    ...
    version = "20190325g" + (builtins.substring 0 8 "${src.rev}");

    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "3441423481b7b2e7f127555633b62220aeca500b";
      sha256 = "10ajp3dqq9dbkgvkz8ang0clp6s8ydiyqsb7jcm7m1hy9jjhgbqr";
    };
