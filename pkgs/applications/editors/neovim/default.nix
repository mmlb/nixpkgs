...
in
  stdenv.mkDerivation rec {
    ...
    version = "20190415"+ (builtins.substring 0 9 "g${src.rev}");

    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "987619ddd73e792dc04b1a408b92cef2abb52bef";
      sha256 = "0swzrnhlxpd6ncmia65rv4m5lvb61m2cmsd17nw7j3lr25cqj4iw";
    };
