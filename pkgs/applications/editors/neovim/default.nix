...
in
  stdenv.mkDerivation rec {
    ...
    version = "20190206" + (builtins.substring 0 8 "${src.rev}");

    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "ed0e96cd28f870c4a580c9e8ab74340fecc90fcb";
      sha256 = "0ffgvssikkb3ljwhix95rj8gzns2ksmcrrcv8bwskzgxf762rll0";
    };
