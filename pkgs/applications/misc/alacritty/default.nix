...
in buildRustPackage rec {
  pname = "alacritty";
  version = "unstable-2020-01-21g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "alacritty";
    repo = pname;
    rev = "767d59155a5d834d22ccb7c7d439b418ffad5404";
    sha256 = "0b6vxy7x6g0r8hqcis6z5p8fl76zwzwivmwn7yipv9yk0fnyyawp";
  };
