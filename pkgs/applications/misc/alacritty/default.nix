...
in buildRustPackage rec {
  ...
  version = "unstable-2019-08-17g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "jwilm";
    repo = "alacritty";
    rev = "a8692983f522e9bd37911d14dc441391a7ee2f50";
    sha256 = "0s3k3j99y1345x5nwy2m90imnicnf8g4nmkya3p7pilq05mjvl89";
  };
