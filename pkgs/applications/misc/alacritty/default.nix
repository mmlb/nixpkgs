...
in buildRustPackage rec {
  ...
  version = "unstable-2019-09-26g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "jwilm";
    repo = "alacritty";
    rev = "9a0555bbba30c264f617ec9260ca00e0eab70870";
    sha256 = "060x35grpw4vxg6lhnrp6gkdr95c47avy5iwmcaijrpsqazn0nd2";
  };
