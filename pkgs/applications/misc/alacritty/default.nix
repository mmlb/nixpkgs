...
in buildRustPackage rec {
  pname = "alacritty";
  version = "unstable-2019-12-22g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "jwilm";
    repo = pname;
    rev = "44037fa42aa80002ce54f0a8e4a6203e3e12aaf5";
    sha256 = "13f72hvs6fczfisa7r80vngc1j8rlw6h78rhrj7g0i0z57chbbji";
  };
