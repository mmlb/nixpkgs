...
in buildRustPackage rec {
  ...
  version = "unstable-2019-09-10g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "jwilm";
    repo = "alacritty";
    rev = "1067fa609b6a5a0017814cb96d8b21b39b2f83f2";
    sha256 = "04a076f5b887xzq9gjlb90fdhi8ngnrk0cnfpqwkayfa0xd4jafs";
  };
