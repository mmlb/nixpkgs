...
in buildRustPackage rec {
  pname = "alacritty";
  version = "unstable-2020-01-08g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "jwilm";
    repo = pname;
    rev = "5651c3f7114dff611e616865ad02e682779979d9";
    sha256 = "1q4zr1f92llqf9b7hswjabvppmb49gxz6rb62xr42xrkrfkvhynk";
  };
