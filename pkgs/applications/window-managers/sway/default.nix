...
stdenv.mkDerivation rec {
  pname = "sway";
  version = "unstable-2019-12-13g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "swaywm";
    repo = pname;
    rev = "f9ce8749dc4e4f4991aa336aba7137455aa67327";
    sha256 = "0ypf3ynmdr62syapyinxshf026r84b59zsgzhc0q2wnc2w028l2l";
  };
