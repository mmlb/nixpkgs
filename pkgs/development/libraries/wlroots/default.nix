...
stdenv.mkDerivation rec {
  pname = "wlroots";
  version = "unstable-2020-06-06g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "swaywm";
    repo = pname;
    rev = "a3ba82885ca038fc1e51775cac7ce5ada3bad0e1";
    sha256 = "0ffqid5nqm2qg5s02i90pd9scnjqig3c6rljhfg3lgksa5l1jjsg";
  };
