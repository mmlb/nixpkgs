...
stdenv.mkDerivation rec {
  ...
  version = "unstable-2019-06-22g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "swaywm";
    repo = "wlroots";
    rev = "b3f42548d068996995490585e27e16c191b4a64c";
    sha256 = "0xzz1z69jigjnwgz6q8g2lrns001c3fn04jnyy8zpcvkdgcmzkka";
  };
