...
stdenv.mkDerivation rec {
  ...
  version = "20190429g${builtins.substring 0 9 src.rev}";

  src = fetchFromGitHub {
    owner = "swaywm";
    repo = "wlroots";
    rev = "cf3b083c329b4e3ce89d16d77253e30137e86da2";
    sha256 = "11ib8wzkxdyazllzp2kx5mc75jibz8qa1ydjhj990vmqx2rq586z";
  };
