...
buildGoModule rec {
  pname = "elvish";
  version = "unstable-2021-02-18g${builtins.substring 0 9 src.rev}";
  ...
  src = fetchFromGitHub {
    owner = "elves";
    repo = pname;
    rev = "53593c3ab79f7ddaddd60097aad55f601856a355";
    sha256 = "1yw29n0xqwxr8jmw8wvdciypxsh4mbc2vq6zyn0gzpyqmlbsh8mr";
  };
